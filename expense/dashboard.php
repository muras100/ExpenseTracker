...
userArea();
$n = $_SESSION['name'];
$res = mysqli_query($con, "SELECT category.id as categoryId,category.name,expense.* from expense,users,category where expense.categoryId=category.id and expense.userId=users.id and users.userName='$n' order by eDate DESC");
$i = 1;
    ...
    <div class="dis2">
        ...
        ?>
                <div class="record sdiv">
                    ...
                    <div class="detial"><a href="manageExpense.php?id=<?php echo $row['id']; ?>&categoryName=<?php echo $row['name']; ?>&categoryId=<?php echo $row['categoryId']; ?>">Edit</a></div>
